...
megaLaser.damage = 3000;
megaLaser.hitEffect = Fx.hitLancer;
megaLaser.despawnEffect = Fx.none;
megaLaser.hitSize = 4;
megaLaser.lifetime = 16;
megaLaser.pierce = true;

const megaChargeBegin = newEffect(60, e => {
...
const megaLaserShootSmoke = newEffect(26, e => {
